...
public void setup()
{
  ...
  {
    video = new GSCapture(this, 640, 480, "/dev/video2");
  }
  else if(webcam_type == 3)
  {
    video = new GSCapture(this, 640, 480, "/dev/video3");
  }
  else if(webcam_type == 4)
  {
    video = new GSCapture(this, 640, 480, "/dev/video4");
  }
  else if(webcam_type == 5)
  {
    video = new GSCapture(this, 640, 480, "/dev/video5");
  }
  else
...
public void load_ha_ini()
{
  ...
  System.out.println("webcam_type: " + webcam_type);
